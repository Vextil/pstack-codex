...
1. Spawn one read-only Codex subagent and tell it to invoke `$comment-sicko` on the scope. Pass the scope by path or diff reference; do not restate the reviewer's rules.
